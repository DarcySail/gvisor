...
//     parameters by design). Passing arguments to interface methods can lead
//     to heap allocation as the compiler won't be able to perform escape
//     analysis on an unknown implementation at compile time. This should be
//     kept this way (in case the interfaces are extended in the future).
//
// Notes:
